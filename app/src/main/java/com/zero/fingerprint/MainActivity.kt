...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (getManagers()) {
            ...
            if (cipherInit()) {
                ...
                authStatus.text = getString(R.string.verify_fingerprint_to_continue)
                val helper = FingerprintHandler(this, authStatus)
    ...
    private fun getManagers(): Boolean {
        ...
        if (fingerprintManager?.isHardwareDetected == false){
            authStatus.text = getString(R.string.fingerprint_error_hw_not_available)
            return false
        }
        ...
        if (fingerprintManager?.hasEnrolledFingerprints() == false) {
            authStatus.text = getString(R.string.fingerprint_error_no_fingerprints)
            return false
        }
        return true
    }
